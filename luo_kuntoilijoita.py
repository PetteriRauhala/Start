...
waist = questions.Question.ask_user_float('Mikä on vyötärönympäryksesi? (cm): ', True)[0]

# If woman ask circumference of her hips
if gender == 0:
    hips = questions.Question.ask_user_float('Mikä on lantionympäryksesi? (cm): ', True)[0]
